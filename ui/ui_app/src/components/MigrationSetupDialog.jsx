...
export default function MigrationSetupDialog({
    ...
    const handleValidate = async () => {
        ...
        const payload = {
            ...
            target_bdd_framework: targetBdd,
            target_build_tool: targetBuild,
            target_runner: targetRunner,
            target_base_path: targetPath.trim(),
            new_repo_name: newRepoName.trim(),
        };

        const res = await validateMigrationSetup(payload);
        setSubmitting(false);
    ...
    return (
        <Dialog open={open} onClose={onClose} maxWidth="md" fullWidth>
            ...
            <DialogActions>
                ...
                >
                    {submitting ? 'Validating…' : 'I Approve to proceed for migration'}
                </Button>
            </DialogActions>
        </Dialog>
    );
